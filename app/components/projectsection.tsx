...
function ProjectSection() {
  ...
  const projects = [
    {
      title: "SA Jundu bin Amin",
      description:
        "A comprehensive e-commerce platform where users buy products and see products avaliable.",
      tech: ["React", "Javascript", "Tailwindcss"],
      type: "Frontend",
      link: "https://sudia-s-shop.vercel.app/",
    },
    {
      title: "Movie Website",
      description:
        "A website for movies and featured movies for users to see and watch",
      tech: ["Nextjs", "Typescript", "Tailwind"],
      type: "Frontend",
      link: "https://movie-next-8dv1.vercel.app/",
    },
    {
      title: "Jamb-App",
    ...
    },
    {
      title: "TODO Server",
      description:
        "these is a todo that has endpoints for add-todo, seealltodo, register, login, delete, pastdate, seealluser.",
